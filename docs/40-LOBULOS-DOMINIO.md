...
`skills/` + tool Skill = **expertise general de terceros** (NO es neurona; recurso paralelo). **Catálogo → `docs/skills-inventory.md`** (112 carpetas, medido 2026-09-04 · lo vigila el gate #6). Al disparar
