...
4b. **Verificación PROPIA antes de actuar (añadido 2026-07-10, auditoría anti-fugas)**: los hallazgos de finders/comité son HIPÓTESIS, no verdades — re-verifica cada P0/P1 leyendo el código/dato con tus propios ojos ANTES de arreglar o reportar al dueño (los agentes producen rutas plausibles que no existen). Exige a cada finder: `archivo:línea + escenario paso a paso`, tope de hallazgos, y **declarar SANAS las áreas limpias** (el silencio no es cobertura). Solo lo confirmado se actúa; lo demás se descarta con nota.
