> **⚠️ VENDORIZADO 2026-09-03 (C4-4 · DICTAMEN-C4 §8 D-C4-13)** — fichero NUEVO del upstream, texto ÍNTEGRO y sin recortar.
> Repo: `github.com/coreyhaines31/marketingskills` · ruta: `skills/ad-creative/references/short-form-video-specs.md`
> versión: skill **v2.8.2** (tag del repo **v2.11.0**) · licencia **MIT © 2025 Corey Haines** (ver `../LICENSE-marketingskills.txt`) · consultado el **2026-09-03**.
> Cross-refs del origen → nuestros nombres: `ads` = `paid-ads`. La capa ALTORRA NO vive aquí: vive en el `SKILL.md` (§ Puente ALTORRA).
