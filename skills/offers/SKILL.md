...
> Nota propia: las GARANTÍAS de la Value Equation tienen implicaciones legales en CO → gate `legal-colombia` antes de prometer nada; prohibido garantizar resultados en pauta (§10).
