> **⚠️ VENDORIZADO 2026-09-03 (C4-4 · DICTAMEN-C4 §8 D-C4-15)** — fichero NUEVO del upstream, texto ÍNTEGRO y sin recortar.
> Repo: `github.com/coreyhaines31/marketingskills` · ruta: `skills/ads/references/audit-guardrails.md`
> versión: skill **v2.3.2** (tag del repo **v2.11.0**) · licencia **MIT © 2025 Corey Haines** (ver `../LICENSE-marketingskills.txt`) · consultado el **2026-09-03**.
> Cross-refs del origen → nuestros nombres: `ads` = `paid-ads`. La capa ALTORRA NO vive aquí: vive en el `SKILL.md`.
> Nota nuestra: la sección «Untrusted data and live accounts» dice lo mismo que §3.3 del router (evidencia antes de afirmar) y que el gate `legal-colombia` sobre las cifras — no la contradice, la refuerza.
