> ⚠️ MATERIA PRIMA (2026-07-18): chuleta GAQL/métricas/tipos de campaña vendorizada de tools/integrations del repo marketingskills. Su CLI usaba **API v14 (MUERTA, sunset 2024)** — NO usar endpoints/versiones de aquí sin re-verificar contra la doc VIGENTE de Google Ads API. Insumo para la futura skill de Google Ads.
