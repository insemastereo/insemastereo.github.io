...
> Nota propia: las tablas de modelos AI (Veo/Sora/Kling) y precios CADUCAN rápido (L-30) — re-verificar antes de gastar; la ruta $0 real: celular + CapCut + Hyperframes (open-source).
