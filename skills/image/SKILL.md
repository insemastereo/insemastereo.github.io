...
> Nota propia: las APIs de generación (Gemini/Flux/Ideogram) cuestan — default: Canva MCP disponible + assets propios; la OPTIMIZACIÓN web de imágenes la manda nuestra `image-pipeline` (no duplicar).
