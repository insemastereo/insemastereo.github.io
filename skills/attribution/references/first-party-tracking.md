> **⚠️ VENDORIZADO 2026-09-03 (C4-5 · DICTAMEN-C4 §9 D-C4-22)** — texto ÍNTEGRO del upstream, sin recortar.
> Repo: `github.com/coreyhaines31/marketingskills` · ruta: `skills/attribution/references/first-party-tracking.md`
> versión: skill **v1.1.0** (tag del repo **v2.11.0**) · licencia **MIT © 2025 Corey Haines** (ver `../LICENSE-marketingskills.txt`) · consultado el **2026-09-03**.
> 🔴 **NO ejecutes este código tal cual.** Es el ejemplo trabajado del origen (PostHog + SavvyCal) y aquí no
> usamos ninguno de los dos. Antes de instrumentar cualquier `identify()`, stitching cross-dominio o volcado al
> CRM: **Ley 1581/2012 + gate `legal-colombia`** (`SKILL.md` § Puente ALTORRA, regla 5). El «anonymity guard,
> fail closed» no es aquí una buena práctica: es cumplimiento.
