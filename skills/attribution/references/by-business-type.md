...
> Repo: `github.com/coreyhaines31/marketingskills` · ruta: `skills/attribution/references/by-business-type.md`
...
> ⚠️ Ninguno de los dos perfiles del origen es el nuestro: inmobiliaria y joyería son **ciclo largo, ticket alto y
> cierre por WhatsApp**, o sea el patrón B2B (CRM como verdad, self-reported fuerte) con volumen de DTC.
> La adaptación manda y vive en el `SKILL.md` (§ Puente ALTORRA).
